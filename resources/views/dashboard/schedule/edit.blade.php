                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="incident[scheduled_end]" class="form-control" rel="datepicker" value="{{ $schedule->scheduled_end_datetimepicker }}" required placeholder="{{ trans('forms.incidents.scheduled_end') }}">
                        </div>
                </fieldset>
